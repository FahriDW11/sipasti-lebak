    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
        <div class="flex w-full bg-primary text-primary-content min-h-16">
            <a href="/admin" class="w-full flex items-center justify-center grow normal-case text-xl overflow-hidden">
                ...
                <span class="is-drawer-close:hidden ml-2 truncate">Admin Panel</span>
            </a>
        </div>
        ...
        <ul class="menu w-full grow bg-primary/10 border-r border-primary/20">
            ...
            <li>
            <a href="/admin" class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ $active === 'dashboard' ? 'bg-primary text-primary-content' : '' }}" data-tip="Dashboard">
            ...
            <li>
            <a href="/admin/kegiatan" class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ $active === 'kegiatan' ? 'bg-primary text-primary-content' : '' }}" data-tip="Kegiatan">
            ...
            <li>
            <a href="/admin/log-kegiatan" class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ $active === 'log-kegiatan' ? 'bg-primary text-primary-content' : '' }}" data-tip="Log Kegiatan">
            ...
            <!-- List item 4: Pembina -->
            <li>
            <a href="/admin/pembina" class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ $active === 'pembina' ? 'bg-primary text-primary-content' : '' }}" data-tip="Pembina">
                <!-- Pembina icon (Menggunakan Lucide User) -->
                <x-lucide-user class="my-1.5 inline-block size-4" />
                <span class="is-drawer-close:hidden">Pembina</span>
            </a>
            </li>

            <!-- List item 5: Tahanan -->
            <li>
            <a href="/admin/tahanan" class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ $active === 'tahanan' ? 'bg-primary text-primary-content' : '' }}" data-tip="Tahanan">
